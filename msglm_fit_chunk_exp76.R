# Msglm fit chunk for the HeLa GPKOW KD data, fp

Sys.setenv(MKL_NUM_THREADS = 1)

#job.args <- c("yhuang_iav", "msglm_yhuang_iav_phubel_exp76", "20231007", "20231008", "107")
if (!exists('job.args')) {
...
rdata_filepath <- file.path(scratch_path, paste0(project_id, "_msglm_data_phubel_exp76_20231007_", fit_version, ".RData"))
